...
describe("recurly secure parameters signer", function() {
  var recurlyUnencoded =
    "account[account_code]=123&nonce=unique&timestamp=1329942896&transaction[amount_in_cents]=5000&transaction[currency]=USD";
  var recurlyEncoded =
    "account%5Baccount_code%5D=123&nonce=unique&timestamp=1329942896&transaction%5Bamount_in_cents%5D=5000&transaction%5Bcurrency%5D=USD";
  ...
  it("generates a final signed parameter string in the expected format", function() {
    ...
    var transactionTestExpected =
      "95c000d2aa045cb20596b8a751b08c8dfaee8cf2|account%5Baccount_code%5D=123&nonce=unique&timestamp=1329942896&transaction%5Bamount_in_cents%5D=5000&transaction%5Bcurrency%5D=USD";
  ...
  it("can sign subscription form parameters", function() {
    ...
    var subscriptionTestExpected =
      "295bd0626ab03fd01053fb0784bd5187b563cbeb|account%5Baccount_code%5D=123&nonce=unique&subscription%5Bplan_code%5D=gold&timestamp=1329942896";
  ...
  it("can sign update billing info form parameters", function() {
    ...
    var expected =
      "86509e315e8396423e420839a9c4cbafd5f230f3|account%5Baccount_code%5D=123&nonce=unique&timestamp=1329942896";
    var result = query.toString();
